...
const RiwayatIzinBelajar = () => {
  let pegawaiId: string = "";
  const [data, setData] = useState<DataIzinBelajar[]>([]);
  ...
  return (
    <BoxRiwayat title="Riwayat Izin Belajar">
      <div className="pt-3">
        <table className="table-auto min-w-full">
          ...
          <tbody>
            {data &&
              data.map((item: DataIzinBelajar, index: number) => (
                <tr
                  key={item.id}
                  onClick={() => {}}
...
export default RiwayatIzinBelajar;
