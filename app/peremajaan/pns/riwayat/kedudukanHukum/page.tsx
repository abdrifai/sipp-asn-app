...
const RiwayatKedudukanHukum = () => {
  ...
  const [data, setData] = useState<DataKedudukanHukum[]>([]);
  ...
  return (
    <BoxRiwayat title="Riwayat Kedudukan Hukum">
      <div className="pt-3">
        <table className="table-auto min-w-full">
          ...
          <tbody>
            {data &&
              data.map((item: DataKedudukanHukum, index: number) => (
                <tr
                  key={item.id}
                  onClick={() => {}}
